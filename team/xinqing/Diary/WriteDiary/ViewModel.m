...
- (void)addAllViews
{
    ...
    //切换图片1
    self.imagView1 = [[ImageViewMine alloc] init];
...
//    self.control1 = changPic1;
   ...
   //图片2
    self.imagView2 = [[ImageViewMine alloc] init];
...
//    self.control2 = changPic2;
    ...
    self.imagView3 = [[ImageViewMine alloc] init];
...
//    
    ...
    self.imagView4 = [[ImageViewMine alloc] init];
...
//    self.control4 = changPic4;
    ...
    self. imagView5 = [[ImageViewMine alloc] init];
...
//    self.control5 = changPic5;
    ...
    self. imagView6 = [[ImageViewMine alloc] init];
...
//    [self.scrollViewMain addSubview:labelTime];
    [imagView addSubview:labelTime];
    self.labelTime = labelTime;
    
    //内容标题
    UITextField *labelName = [[UITextField alloc] init];
    labelName.font = [UIFont fontWithName:@"Helvetica" size:20];
    labelName.textAlignment = NSTextAlignmentCenter;
    labelName.placeholder = @"心晴日记";
    labelName.userInteractionEnabled = NO;
