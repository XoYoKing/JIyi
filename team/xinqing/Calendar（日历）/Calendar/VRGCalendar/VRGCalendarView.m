...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextSetFillColorWithColor(context, [[UIColor alloc] initWithRed:241/255.0 green:168/255.0 blue:114/255.0 alpha:1].CGColor);
...
#warning dsfsfsf
    ...
    for (int i=0; i<numBlocks; i++) {
        ...
        if (selectedDate && i==selectedDateBlock) {
            ...
            CGRect rectangleGrid = CGRectMake(targetX,targetY,kVRGCalendarViewDayWidth+2,kVRGCalendarViewDayHeight+2);
            CGContextAddRect(context, rectangleGrid);
            CGContextSetFillColorWithColor(context, [[UIColor alloc] initWithRed:237/255.0 green:145/255.0 blue:200/255.0 alpha:1].CGColor);
            CGContextFillPath(context);
